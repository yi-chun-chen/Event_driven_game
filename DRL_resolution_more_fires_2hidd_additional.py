learning_rate_given = 0.0002
UAV_task.t_fail = [0.001,0.002]
n_batch_size = 3000
for j in range(1):
  ...
  for iteration_times in range(it_time):
    ...
    if iteration_times == 0:
      ...
      h_train_step = 20 * h_step_for_gradient
    ...
    visualize_scenario_indp([0,size**2-1,1,1,1,1,1,1],50,0.2,UAV_task)
    print("================")
    visualize_scenario_indp([0,size**2-1,1,1,1,1,1,1],50,0.2,UAV_task)
    print("================")
    visualize_scenario_indp([0,size**2-1,1,1,1,1,1,1],50,0.2,UAV_task)
    ...
    for h in range(h_train_step):
      ...
      action_chosen_1 = es_greedy(sess.run(Q_a1, feed_dict={last_info_a1: [last_info_1_norm]}),0.4)#0.1 + r_explore * (1 - float(h)/h_train_step))
