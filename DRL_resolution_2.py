...
W1_for_feed_train_a0 = np.random.rand(8,n_hidd) * 0.5 - np.ones((8,n_hidd),float)
...
W1_for_feed_train_a1 = np.random.rand(8,n_hidd) * 0.5 - np.ones((8,n_hidd),float)
