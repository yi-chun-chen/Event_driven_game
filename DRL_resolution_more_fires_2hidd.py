...
W3_train_a0 = tf.placeholder(tf.float32,[n_hidd,5])
b3_train_a0 = tf.placeholder(tf.float32,[1,5])
...
W3_train_a1 = tf.placeholder(tf.float32,[n_hidd,5])
b3_train_a1 = tf.placeholder(tf.float32,[1,5])
...
layer_out_a0 = add_layer(layer_2_a0[0], n_hidd,                 5, activation_function = None)
Q_a0 = layer_out_a0[0]
...
Q_next_a0 =   copy_layer(layer_c2_a0,  W3_train_a0, b3_train_a0, activation_function = None)
...
layer_out_a1 = add_layer(layer_2_a1[0],       n_hidd,           5, activation_function = None)
Q_a1 = layer_out_a1[0]
...
Q_next_a1 =   copy_layer(layer_c2_a1,  W3_train_a1, b3_train_a1, activation_function = None)
...
#W1_for_feed_train_a0 = 0.1 * (np.random.rand(input_number,n_hidd) * 0.5 - np.ones((input_number,n_hidd),float))
b1_for_feed_train_a0 = np.ones((1,n_hidd),float) * 0.1
W2_for_feed_train_a0 = sess.run(initializer((n_hidd, n_hidd)))
#W2_for_feed_train_a0 = 0.1 * (np.random.rand(n_hidd,n_hidd) * 0.5 - np.ones((n_hidd,n_hidd),float))
b2_for_feed_train_a0 = np.ones((1,n_hidd),float) * 0.1
W3_for_feed_train_a0 = sess.run(initializer((n_hidd, 5)))
#W3_for_feed_train_a0 = 0.1 * (np.random.rand(n_hidd,5) * 0.5 - np.ones((n_hidd,5),float))
b3_for_feed_train_a0 = np.ones((1,5),float) * 0.1

W1_for_feed_train_a1 = sess.run(initializer((input_number, n_hidd)))
#W1_for_feed_train_a1 = 0.1 * (np.random.rand(input_number,n_hidd) * 0.5 - np.ones((input_number,n_hidd),float))
b1_for_feed_train_a1 = np.ones((1,n_hidd),float) * 0.1
W2_for_feed_train_a1 = sess.run(initializer((n_hidd, n_hidd)))
#W2_for_feed_train_a1 = 0.1 * (np.random.rand(n_hidd,n_hidd) * 0.5 - np.ones((n_hidd,n_hidd),float))
b2_for_feed_train_a1 = np.ones((1,n_hidd),float) * 0.1
W3_for_feed_train_a1 = sess.run(initializer((n_hidd, 5)))
#W3_for_feed_train_a1 = 0.1 * (np.random.rand(n_hidd,5) * 0.5 - np.ones((n_hidd,5),float))
b3_for_feed_train_a1 = np.ones((1,5),float) * 0.1
  ...
  for iteration_times in range(it_time):
    ...
    for h in range(h_train_step):
      ...
      if h% (h_step_for_gradient * 50) == 0:
        ...
        W2_for_feed_train_a0 = sess.run(layer_2_a0[1], feed_dict={last_info_a0: [last_info_0]})
        b2_for_feed_train_a0 = sess.run(layer_2_a0[2], feed_dict={last_info_a0: [last_info_0]})
        W3_for_feed_train_a0 = sess.run(layer_out_a0[1], feed_dict={last_info_a0: [last_info_0_norm]})
        b3_for_feed_train_a0 = sess.run(layer_out_a0[2], feed_dict={last_info_a0: [last_info_0_norm]})
    ...
    for h in range(h_train_step):
      ...
      if h% (h_step_for_gradient * 50) == 0:
        ...
        W3_for_feed_train_a1 = sess.run(layer_out_a1[1], feed_dict={last_info_a1: [last_info_1_norm]})
        b3_for_feed_train_a1 = sess.run(layer_out_a1[2], feed_dict={last_info_a1: [last_info_1_norm]})
