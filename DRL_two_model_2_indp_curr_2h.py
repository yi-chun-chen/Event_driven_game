...
class UAV_fire_extinguish(object):
  ...
  t_fail = (0.02,0.08)
  t_emit = (0.7,0.7)
  l_fire = (3,6,12)#(5,10,30)
  r_fire = (2.0,1.0,10.0)
  e_fire = [[0.5,0.9],[0.9,0.9],[0.5,0.9]]
  horizon = 20
  horizon = 5
...
W1_for_feed_train_a0 = np.ones((9,n_hidd),float) * 0.1
b1_for_feed_train_a0 = np.ones((1,n_hidd),float) * 0.1
W2_for_feed_train_a0 = np.ones((n_hidd,n_hidd),float) * 0.1
b2_for_feed_train_a0 = np.ones((1,n_hidd),float) * 0.1
W3_for_feed_train_a0 = np.ones((n_hidd,5),float) * 0.1
b3_for_feed_train_a0 = np.ones((1,5),float) * 0.1

W1_for_feed_train_a1 = np.ones((9,n_hidd),float) * 0.1
b1_for_feed_train_a1 = np.ones((1,n_hidd),float) * 0.1
W2_for_feed_train_a1 = np.ones((n_hidd,n_hidd),float) * 0.1
b2_for_feed_train_a1 = np.ones((1,n_hidd),float) * 0.1
W3_for_feed_train_a1 = np.ones((n_hidd,5),float) * 0.1
...
for task in range(4):
  ...
  if task == 2:
    ...
    outcome = [(s0_array,a0_array,r0_array,s0p_array),(s1_array,a1_array,r1_array,s1p_array)]

    print("simulate0")

    outcome = add_simulation([0,16,1,1,1],
                             1000,
                             30,
                             outcome[0],
                             outcome[1],
    ...
    outcome = add_simulation([4,16,1,1,1],
                             1000,
                             30,
                             outcome[0],
                             outcome[1],
    ...
    outcome = add_simulation([8,16,1,1,1],
                             1000,
                             30,
                             outcome[0],
                             outcome[1],
    ...
    outcome = add_simulation([12,16,1,1,1],
                             1000,
                             30,
                             outcome[0],
                             outcome[1],
  ...
  for iteration_times in range(it_time):
    ...
    for h in range(h_train_step):
      ...
      s0_array = np.vstack([s0_array, [rate] + last_info_0])
      sp0_array = np.vstack([sp0_array, [rate] + next_info_0])
      r0_array = np.vstack([r0_array, reward_immed])

      s1_array = np.vstack([s1_array, [rate] + last_info_1])
      sp1_array = np.vstack([sp1_array, [rate] + next_info_1])
      ...
      if h% (h_step_for_gradient * 50) == 0:
        ...
        W2_for_feed_train_a0 = sess.run(layer_2_a0[1], feed_dict={last_info_a0: [[rate] +last_info_0]})
        b2_for_feed_train_a0 = sess.run(layer_2_a0[2], feed_dict={last_info_a0: [[rate] +last_info_0]})
        W3_for_feed_train_a0 = sess.run(layer_out_a0[1], feed_dict={last_info_a0: [[rate] +last_info_0]})
        b3_for_feed_train_a0 = sess.run(layer_out_a0[2], feed_dict={last_info_a0: [[rate] +last_info_0]})
      ...
      if h % h_step_for_gradient == 0:
        ...
        s0_array = truncate_dataset(s0_array,n_init_pool*6)
        r0_array = truncate_dataset(r0_array,n_init_pool*6)
        a0_array = truncate_dataset(a0_array,n_init_pool*6)
        sp0_array = truncate_dataset(sp0_array,n_init_pool*6)

        s1_array = truncate_dataset(s1_array,n_init_pool*6)
        r1_array = truncate_dataset(r1_array,n_init_pool*6)
        a1_array = truncate_dataset(a1_array,n_init_pool*6)
        sp1_array = truncate_dataset(sp1_array,n_init_pool*6)
    ...
    for h in range(h_train_step):
      ...
      if h% (h_step_for_gradient * 50) == 0:
        ...
        W2_for_feed_train_a1 = sess.run(layer_2_a1[1], feed_dict={last_info_a1: [[rate] + last_info_1]})
        b2_for_feed_train_a1 = sess.run(layer_2_a1[2], feed_dict={last_info_a1: [[rate] + last_info_1]})
        W3_for_feed_train_a1 = sess.run(layer_out_a1[1], feed_dict={last_info_a1: [[rate] + last_info_1]})
        b3_for_feed_train_a1 = sess.run(layer_out_a1[2], feed_dict={last_info_a1: [[rate] + last_info_1]})
